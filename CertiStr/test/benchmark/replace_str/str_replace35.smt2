...
(assert (= literal_11 "\x20\x4f\x52\x20\x62\x6c\x61\x63\x6b\x6c\x69\x73\x74\x5f\x69\x70\x3d"))

(assert (= literal_22 "\x20\x4f\x52\x20\x62\x6c\x61\x63\x6b\x6c\x69\x73\x74\x5f\x69\x70\x3d"))

(assert (= literal_23 "\x20\x28\x61\x64\x6d\x69\x6e\x5f\x72\x69\x67\x68\x74\x73\x3d\x27"))

(assert (= literal_27 "\x27\x29"))

(assert (= literal_26 "\x66\x6f\x72\x75\x6d\x5f\x69\x64\x3d\x27"))

(assert (= literal_31 "\x27"))

(assert (= literal_29 "\x66\x6f\x72\x75\x6d\x5f\x63\x61\x74\x3d\x27"))
...
(assert (= literal_50 "\x27"))

(assert (= literal_51 "\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x6c\x69\x6e\x6b\x21\x3d\x27\x72\x65\x73\x65\x72\x76\x65\x64\x27\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x70\x61\x67\x65\x3d\x27\x33\x27"))
...
(assert (= literal_53 "\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x6c\x69\x6e\x6b\x21\x3d\x27\x72\x65\x73\x65\x72\x76\x65\x64\x27\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x70\x61\x67\x65\x3d\x27\x34\x27"))
...
(assert (= literal_80 "\x66\x6f\x72\x75\x6d\x73"))
...
(assert (= literal_74 "\x70\x6f\x73\x74\x73"))
...
(assert (= x_13 sigmaStar_252))

(assert (= x_14 x_13))

(assert (= x_14 literal_12))



(assert (= x_18 (str.++ literal_11 sigmaStar_755)))
...
(assert (= x_24 (str.++ x_18 literal_22)))




(assert (= x_25 (str.++ literal_23 x_20)))




(assert (= x_28 (str.++ x_24 sigmaStar_2161)))




(assert (= x_30 (str.++ x_25 literal_27)))




(assert (= x_40 (str.++ literal_26 sigmaStar_064)))




(assert (= x_41 (str.++ x_28 literal_31)))




(assert (= x_42 (str.++ literal_29 sigmaStar_167)))
...
(assert (= x_57 (str.++ x_40 literal_50)))




(assert (= x_58 (str.++ x_30 literal_51)))




(assert (= x_59 (str.++ sigmaStar_n0 literal_52)))
