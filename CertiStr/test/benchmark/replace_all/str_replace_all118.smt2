...
(assert (= literal_20 "\x20\x4f\x52\x20\x62\x6c\x61\x63\x6b\x6c\x69\x73\x74\x5f\x69\x70\x3d"))

(assert (= literal_21 "\x20\x28\x61\x64\x6d\x69\x6e\x5f\x72\x69\x67\x68\x74\x73\x3d\x27"))

(assert (= literal_24 "\x27\x29"))
...
(assert (= literal_62 "\x62\x6c\x61\x63\x6b\x6c\x69\x73\x74"))
...
(assert (= x_8 sigmaStar_safe_50))

(assert (= x_8 sigmaStar_safe_51))

(assert (= x_11 sigmaStar_052))

(assert (= x_11 x_8))

(assert (= x_12 x_11))

(assert (= x_12 literal_10))



(assert (= x_16 (str.++ literal_9 sigmaStar_555)))


(assert (= x_18 (str.replace_all x_12 "." "' OR admin_rights='") ))
...
(assert (= x_23 (str.++ literal_21 x_18)))




(assert (= x_25 (str.++ x_22 sigmaStar_1961)))
...
(assert (= x_34 (str.++ x_25 literal_27)))
...
(assert (= x_45 (str.++ x_26 literal_40)))
...
(assert (= x_48 (str.++ sigmaStar_n2 literal_43)))




(assert (= x_49 (str.++ literal_28 x_34)))
