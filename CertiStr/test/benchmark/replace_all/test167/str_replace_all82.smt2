...
(assert (= x_14 (str.++ literal_11 sigmaStar_153)))
...
(assert (= x_27 (str.replace_all x_20 "." "' OR admin_rights='") ))
...
(assert (= x_30 (str.++ x_23 sigmaStar_363)))
...
(assert (= x_46 (str.++ x_35 sigmaStar_269)))
