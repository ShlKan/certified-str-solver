...
(assert (= x_23 literal_1))

(assert (= x_23 sigmaStar_2256))

(assert (= x_27 (str.replace_all x_23 "\\'" "\'") ))

(assert (= x_31 (str.replace_all x_27 "\\""" """") ))

(assert (= x_35 (str.replace_all x_31 "\\\\" "\\") ))

(assert (= x_36 sigmaStar_n0))
