...
(assert (= x_15 (str.replace_re sigmaStar_348 (re.++ (str.to_re "<SCRIPT" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (re.++ (str.to_re ">" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (re.++ (str.to_re "</SCRIPT" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (str.to_re ">" ))))))) "SCRIPT BLOCKED") ))

(assert (= x_24 (str.replace_re sigmaStar_552 (re.++ (str.to_re "<SCRIPT" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (re.++ (str.to_re ">" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (re.++ (str.to_re "</SCRIPT" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (str.to_re ">" ))))))) "SCRIPT BLOCKED") ))
...
(assert (= x_82 (str.++ sigmaStar_278 x_81)))
