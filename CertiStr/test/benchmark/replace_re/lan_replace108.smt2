...
(assert (= x_10 (str.replace_re sigmaStar_048 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_37 (str.replace_re sigmaStar_162 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
