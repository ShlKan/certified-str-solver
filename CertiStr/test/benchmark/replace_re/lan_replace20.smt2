...
(assert (= x_17 (str.replace_re sigmaStar_552 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_98 (str.++ sigmaStar_390 x_97)))
