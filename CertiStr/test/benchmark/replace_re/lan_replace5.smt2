...
(assert (= x_24 (str.replace_re sigmaStar_052 (re.++ (str.to_re "<SCRIPT" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (re.++ (str.to_re ">" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (re.++ (str.to_re "</SCRIPT" ) (re.++ (re.union (re.* re.allchar) (str.to_re "" ) ) (str.to_re ">" ))))))) "SCRIPT BLOCKED") ))
