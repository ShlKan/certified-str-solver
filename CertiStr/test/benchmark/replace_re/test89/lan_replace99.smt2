...
(assert (= x_10 (str.replace_re sigmaStar_648 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))

(assert (= x_17 (str.replace_re sigmaStar_152 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_37 (str.replace_re sigmaStar_262 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_98 (str.++ sigmaStar_090 x_97)))
