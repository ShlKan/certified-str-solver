...
(assert (= x_10 (str.replace_re sigmaStar_548 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))

(assert (= x_17 (str.replace_re sigmaStar_652 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_37 (str.replace_re sigmaStar_462 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
