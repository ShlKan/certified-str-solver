...
(assert (= x_10 (str.replace_re sigmaStar_348 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_37 (str.replace_re sigmaStar_662 (re.++ (str.to_re "<SCRIPT" ) (re.union (re.* re.allchar) (str.to_re "" ) )) "BLOCKED") ))
...
(assert (= x_98 (str.++ sigmaStar_490 x_97)))
