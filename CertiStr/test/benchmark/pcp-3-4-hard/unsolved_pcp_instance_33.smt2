...
(assert (= x_1 (str.replace_all x_0 "2" "1111")))
(assert (= x_2 (str.replace_all x_1 "3" "1010")))
(assert (= x (str.replace_all x_2 "4" "111")))
(assert (= y_1 (str.replace_all y_0 "2" "1010")))
(assert (= y_2 (str.replace_all y_1 "3" "01")))
(assert (= y (str.replace_all y_2 "4" "1111")))
