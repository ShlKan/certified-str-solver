...
(assert (= x_2 (str.replace_all x_1 "3" "0100")))
(assert (= x (str.replace_all x_2 "4" "01")))
(assert (= y_1 (str.replace_all y_0 "2" "111")))
(assert (= y_2 (str.replace_all y_1 "3" "0011")))
(assert (= y (str.replace_all y_2 "4" "1010")))
