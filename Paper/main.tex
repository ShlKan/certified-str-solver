...
Future work includes extending our symbolic formalization to handle variants of SFTs. One particularly promising direction is the addition of transition priorities, which would enable precise modeling of SMT-LIB's standard semantics for replacement operations.
