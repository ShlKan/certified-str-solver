...
\cite{Kern}, which epitomizes the importance of the replaceall operator and
string transductions, as well as other string operators like concatenation.
