        ...
        proof -
          ...
          assume ind_hyp: "\<And>q q1 q1'.
           ...
           \<exists>\<pi>. [] = outputE \<pi> \<and>
               LTTS_reachable (\<Delta>T \<T>) (\<M> \<T>) q1 \<pi> q2 \<and>
               LTS_is_reachable (NFA_set.NFA_rec.\<Delta> \<A>) q1' (inputE \<pi>)
                q2'"
...
proof -
  ...
  have c1: "SPEC (\<lambda>Q. Q = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>) \<le>
            SPEC (\<lambda>Q. trans_comp (\<M> \<T>) F fe (\<Delta>T \<T>) (NFA_set.NFA_rec.\<Delta> \<A>)
                       (NFA_set.NFA_rec.\<Q> \<A>) \<bind>
                      (\<lambda>(D1, D2).
                          prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>) \<bind>
                          (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
                               (\<lambda>F. RETURN
    ...
    apply simp
  proof -
    have "trans_comp (\<M> \<T>) F fe (\<Delta>T \<T>) (NFA_set.NFA_rec.\<Delta> \<A>)
     (NFA_set.NFA_rec.\<Q> \<A>) \<bind>
    (\<lambda>(D1, D2).
        prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>) \<bind>
        (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
             (\<lambda>F. RETURN
                   \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>, \<Delta>e = D1,
    ...
    proof -
      ...
      have "SPEC (\<lambda>(Dn1, Dn2).
            ...
            {((p, p'), the (F ((\<M> \<T>) f) (\<sigma>1 \<inter> \<sigma>2)), q, q') |p p' \<sigma>1 \<sigma>2 q q' f.
             ...
             (p', \<sigma>2, q') \<in> NFA_set.NFA_rec.\<Delta> \<A> \<and>
            ...
            SPEC (\<lambda>x. (case x of
                  (D1, D2) \<Rightarrow>
                    ...
                    (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
                         (\<lambda>F. RETURN
                               \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
        ...
        apply simp
      proof -
        have "prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>) \<bind>
    (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
         (\<lambda>Fa. RETURN
                \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>, 
                     ...
                     {uu.
                      \<exists>p p' \<sigma>1 \<sigma>2 q q'.
                         ...
                         (\<exists>f. (p, (Some \<sigma>1, f), q) \<in> \<Delta>T \<T> \<and>
                              ...
                              \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
                   \<I>e = I, \<F>e = Fa\<rparr>))
    \<le> SPEC (\<lambda> A. A = \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>, 
               \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                      p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
                      (p, (None, f), q) \<in> \<Delta>T \<T> \<and> (\<exists>So. \<M> \<T> f None = Some So)} \<union>
                     {((p, p'), the (F (\<M> \<T> f) (\<sigma>1 \<inter> \<sigma>2)), q, q') |p p' \<sigma>1 \<sigma>2 q q' f.
                 ...
                 {uu.
                  \<exists>p p' \<sigma>1 \<sigma>2 q q'.
                     ...
                     (\<exists>f. (p, (Some \<sigma>1, f), q) \<in> \<Delta>T \<T> \<and>
                          (p', \<sigma>2, q') \<in> NFA_set.NFA_rec.\<Delta> \<A> \<and>
                          \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
               \<I>e = \<I>T \<T> \<times> NFA_set.NFA_rec.\<I> \<A>,
               \<F>e = \<F>T \<T> \<times> NFA_set.NFA_rec.\<F> \<A>\<rparr>)"
          apply (refine_vcg)
        proof -
          have "SPEC (\<lambda>Q. Q = \<I>T \<T> \<times> NFA_set.NFA_rec.\<I> \<A>) \<le>
                SPEC (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
                 (\<lambda>Fa. RETURN
                        \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>, 
                           \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                                  p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
...
f. p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
   (p, (None, f), q) \<in> \<Delta>T \<T> \<and> (\<exists>So. \<M> \<T> f None = Some So)} \<union>
...
(p, (None, f), q) \<in> \<Delta>T \<T> \<and> \<M> \<T> f None = None)} \<union>
   ...
   \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
            ...
            apply simp
          proof -
            have "prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
    (\<lambda>Fa. RETURN
           \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>, 
              \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                     p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
                ...
                {uu.
                 \<exists>p p' \<sigma>1 \<sigma>2 q q'.
                    ...
                    (\<exists>f. (p, (Some \<sigma>1, f), q) \<in> \<Delta>T \<T> \<and>
                         (p', \<sigma>2, q') \<in> NFA_set.NFA_rec.\<Delta> \<A> \<and>
                         \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
              \<I>e = \<I>T \<T> \<times> NFA_set.NFA_rec.\<I> \<A>, \<F>e = Fa\<rparr>)
    \<le> SPEC (\<lambda> A. A = \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>, 
               \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                      p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
                      (p, (None, f), q) \<in> \<Delta>T \<T> \<and> (\<exists>So. \<M> \<T> f None = Some So)} \<union>
              ...
              apply refine_vcg
            proof -
              have "SPEC (\<lambda>Q. Q = \<F>T \<T> \<times> NFA_set.NFA_rec.\<F> \<A>) \<le> 
...
(\<exists>f. (p, (Some \<sigma>1, f), q) \<in> \<Delta>T \<T> \<and>
     ...
     \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
                ...
                by simp
              from this
              show "prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>)
...
(\<exists>f. (p, (Some \<sigma>1, f), q) \<in> \<Delta>T \<T> \<and>
     ...
     \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
            ...
            from this
            show "prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
    (\<lambda>Fa. RETURN
           \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
              \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                     p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
                ...
                {uu.
                 \<exists>p p' \<sigma>1 \<sigma>2 q q'.
                    ...
                    (\<exists>f. (p, (Some \<sigma>1, f), q) \<in> \<Delta>T \<T> \<and>
                         ...
                         \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
              \<I>e = \<I>T \<T> \<times> NFA_set.NFA_rec.\<I> \<A>, \<F>e = Fa\<rparr>)
    \<le> RES {\<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
               \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                      p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
                      (p, (None, f), q) \<in> \<Delta>T \<T> \<and> (\<exists>So. \<M> \<T> f None = Some So)} \<union>
                     {((p, p'), the (F (\<M> \<T> f) (\<sigma>1 \<inter> \<sigma>2)), q, q') |p p' \<sigma>1 \<sigma>2 q q' f.
          ...
          show "prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>)
    \<le> SPEC (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
                 (\<lambda>Fa. RETURN
                        \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
                           \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
                                  p' \<in> NFA_set.NFA_rec.\<Q> \<A> \<and>
...
(p, (None, f), q) \<in> \<Delta>T \<T> \<and> \<M> \<T> f None = None)} \<union>
   ...
   \<sigma>1 \<inter> \<sigma>2 \<noteq> {} \<and> (\<exists>x\<in>\<sigma>1 \<inter> \<sigma>2. \<M> \<T> f (Some x) = None))},
    ...
    \<le> RES {\<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
          ...
          by auto
        from this
        show "prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>) \<bind>
    (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
         (\<lambda>Fa. RETURN
                \<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
                   \<Delta>e = {((p, p'), the (\<M> \<T> f None), q, p') |p p' q f.
    ...
    \<le> RES {\<lparr>\<Q>e = \<Q>T \<T> \<times> NFA_set.NFA_rec.\<Q> \<A>,
      ...
      show "trans_comp (\<M> \<T>) F fe (\<Delta>T \<T>) (NFA_set.NFA_rec.\<Delta> \<A>)
     (NFA_set.NFA_rec.\<Q> \<A>)
  ...
  have "prods (\<Q>T \<T>) (NFA_set.NFA_rec.\<Q> \<A>)
    \<le> SPEC (\<lambda>Q.  trans_comp (\<M> \<T>) F fe (\<Delta>T \<T>) (NFA_set.NFA_rec.\<Delta> \<A>)
                       (NFA_set.NFA_rec.\<Q> \<A>) \<bind>
                      (\<lambda>(D1, D2).
                          prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>) \<bind>
                          (\<lambda>I. prods (\<F>T \<T>) (NFA_set.NFA_rec.\<F> \<A>) \<bind>
    ...
    using SPEC_trans by force
  from this
  show "prods (\<Q>T \<T>) (NFA_set.NFA_rec.\<Q> \<A>)
    \<le> SPEC (\<lambda>Q. trans_comp (\<M> \<T>) F fe (\<Delta>T \<T>) (NFA_set.NFA_rec.\<Delta> \<A>)
                       (NFA_set.NFA_rec.\<Q> \<A>) \<bind>
                      (\<lambda>(D1, D2).
                          prods (\<I>T \<T>) (NFA_set.NFA_rec.\<I> \<A>) \<bind>
