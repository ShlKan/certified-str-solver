...
definition "rs_lts_union \<equiv> rs_lts_defs.ltsbm_union"

schematic_goal lts_union_aux3: "rs_lts_defs.ltsbm_union_aux3 = ?code"
  unfolding rs_lts_defs.union_aux3_alt rs_lts_defs.union_aux2_alt
            rs_lts_defs.union_aux1_alt
  by (rule refl)+

schematic_goal lts_union_code: "rs_lts_union = ?code_lts_union"
  unfolding rs_lts_union_def rs_lts_defs.ltsbm_union_def lts_union_aux3
            rs_lts_defs.ltsbm_add_def
  by (rule refl)+

lemmas rs_lts_union_code [code] = lts_union_code 
...
definition "rs_lts_succq_it \<equiv> rs_lts_defs.ltsbm_succq_it rs_iteratei"
...
schematic_goal lts_succq_it_code:"rs_lts_succq_it = ?code_lts_succ_it"
  unfolding rs_lts_succq_it_def rs_lts_defs.ltsbm_succq_it_def
  by (rule refl)+

lemmas rs_lts_succ_it_code [code] = lts_succ_it_code

lemmas rs_lts_succq_it_code [code] = lts_succq_it_code
...
lemmas rs_lts_union_impl = rs_lts_defs.ltsbm_union_correct[folded rs_lts_defs]
interpretation rs_lts: lts_union rs_lts_\<alpha> rs_lts_invar rs_lts_union
  using rs_lts_union_impl .
...
lemma rs_lts_ops_unfold[code_unfold] :
    ...
    "clts_op_union rs_lts_ops = rs_lts_union"
